...
class FaceContourGraphic(overlay: GraphicOverlay?) : Graphic(overlay!!) {
    ...
    override fun draw(canvas: Canvas) {
        ...
        val contour: FirebaseVisionFaceContour = face.getContour(FirebaseVisionFaceContour.ALL_POINTS)
        ...
        if (leftEye != null && leftEye.position != null) {
            canvas.drawCircle(
                    ...
                    translateY(leftEye.position.y), FACE_POSITION_RADIUS,
                    facePositionPaint)
        }
        ...
        if (rightEye != null && rightEye.position != null) {
            canvas.drawCircle(
                    ...
                    translateY(rightEye.position.y), FACE_POSITION_RADIUS,
                    facePositionPaint)
        }
        ...
        if (leftCheek != null && leftCheek.position != null) {
            canvas.drawCircle(
                    ...
                    translateY(leftCheek.position.y), FACE_POSITION_RADIUS,
                    facePositionPaint)
        }
        ...
        if (rightCheek != null && rightCheek.position != null) {
            canvas.drawCircle(
                    ...
                    translateY(rightCheek.position.y), FACE_POSITION_RADIUS,
                    facePositionPaint)
        }
    }
